...
namespace FT.Web.Site.Controllers.EventosEIncentivo
{
    public class EventosEIncentivoController : Controller
    {
        //
        // GET: /EventosEIncentivo/
        private string _titulo = "{0}Hotsites/EventosEIncentivo/{1}.htm";
        ...
        public ActionResult Index(string hotsite)
        {
            ...
            cookiePagina.Value = "EventosEIncentivo";
